...
output:
  pagedown::html_paged:
    css: ["css/one-column-paged-academic.css", "css/academicons.min.css",  "https://use.fontawesome.com/releases/v5.7.2/css/all.css"]
...
::: {.title}
<h1 class="title">Ethan Hurwitz</h1>
:::
...
publications %>%
  ...
  mutate(citation = glue("<span class='publication-authors'>{authors_full} ({year}).</span><br>",
                         "<span class='cv-entry-title' style='padding-left: 20px'>{title}. </span>",
